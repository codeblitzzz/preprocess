# Clauses Extracted from outputs/parsed_normalized/TN_Contract1_normalized.json
...
Exclusion and Debarment Screening. Provider shall comply with all federal requirements (42
...
Alternative Claims Processing. In the event that dccms unable to timely process and
...
Tennessee which is a Federally Qualified Health Center as defined in 42
...
§ 223(g), as amended, Provider shall have its liability limits defined
...
self-insurance; and (ii) maintain minimum policy limits equal to $1,000,
...
in the aggregate, or such other coverage amounts as prescribed by applicable
...
Provider further agrees to notify within fourteen (14) days of any
...
here has its usual legal meaning not the defintion used in the CR

## Clause A.

Failure by Provider to obtain written
...
"Emergency Condition" is defined as set forth in the AC

## Clause S.

"Emergency Services" is defined as set forth in the AC
...
audit, or for such longer period provided for in 42 CFR §
...
HHS, the Comptroller General or its designee have the right, pursuant to section
...
Continuation of Care-Insolvency. Provider agrees that in the event of insolvency, termination
...
Data Reporting Requirements. Provider shall provide to all information necessary for or
...
to enable to meet its reporting obligations under 42 CFR §§
...
Risk Adjustment Data. Provider's Risk Adjustment Data shall include all information necessary for or
requested by to enable to submit such data to CMS as set forth in 42 CFR §

## Clause 422.310

or any subsequent or additional regulatory provisions or CMS guidance. If Provider fails to submit
accurate, complete, and truthful Risk Adjustment Data in the format described in 42 CFR §
...
Accuracy of Risk Adjustment Data. Risk Adjustment Data submitted by Provider must be accurate,
...
Compliance with Medical Management Programs. Provider agrees to comply with
...
Compliance: Appeals/Grievances. Provider agrees to comply with policies and procedures in
...
Compliance: Policy and Procedures. Provider agrees to comply with policy and procedures in
...
© 2022 August - Tennessee, Inc. v.2
such compliance training, education and lines of communication available to Provider in either electronic,
paper or other reasonable medium.

## Clause 9.7

Federal Funds. Provider acknowledges that payments Provider receives from to provide MA
...
Notice Upon Termination. If decides to terminate this Attachment, shall give
...
Inconsistencies. In the event of an inconsistency between terms of this Attachment and the terms and
...
Interpret According to Medicare Laws. Provider and intend that the terms of the Agreement and
...
Subcontractors. In addition to the Use of Subcontractors provision of the Agreement, Provider agrees that if
...
Delegated Activities. If has delegated activities to Provider, then will provide the
...
Notification that the performance of the contracted and subcontracted entities will be monitored by

## Clause 12.4.4

Notification that the credentialing process must be approved and monitored by and
...
References to Regulatory Requirements. All references in this Attachment to any Regulatory Requirement
...
© 2022 August - Tennessee, Inc. v.2
COMPENSATION SCHEDULE ("ACS")
ARTICLE I
DEFINITIONS
The definitions set forth below shall apply with respect to all of the terms outlined in this AC
...
© 2022 April - Tennessee, Inc.
"Global Case Rate" means the all-inclusive Rate which includes facility, professional and physician
...
© 2022 April - Tennessee, Inc.
Reimbursement for Rate Based on Eligible Charges. Notwithstanding any reimbursement amount set
...
To the extent mandated by Regulatory Requirements, Provider shall ensure that Members have access to 24 hourper-day, 7 day-per-week urgent and Emergency Services, as defined in the AC

## Clause S.

Tennessee Enterprise Provider Agreement ACS 56 #
© 2022 April - Tennessee, Inc.
Unless otherwise required under Regulatory Requirements, PCP shall provide Covered Services or make
...
same items or services under original Medicare Part A or Part

## Clause B.

The amount payable to Provider shall not include
...
In accordance with TennCare Program Contractor Risk Agreement (CRA) section
...
day)
BMAT Maintenance Phase | HO016HG $
...
Standing Birthing Center, Rehabilitation Facility and SN
